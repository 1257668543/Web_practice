  ...
  <div class="banner-nav">
    ...
    <div class="banner-box">
      ...
      <div
        ...
        @click="slide"
        @mouseenter="hl('banner-icon', $event)"
        @mouseleave="fd('banner-icon', $event)"
      >
        <a-icon type="left" class="forward" />
      </div>
      <div
...
.nav-container .nav-list .nav-item:first-of-type {
  margin-top: 13px;
}
